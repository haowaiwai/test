...
void CMy123Dlg::OnOK() 
{
	...
	if(client.Connect("http://mobile.fm1039e.net/")){
		client.AddPostArgument("f1", "c:\\1.JPG", true);
		client.AddPostArgument("f2", "c:\\2.JPG", true);
		client.AddPostArgument("f3", "c:\\3.JPG", true);
		if(client.Request("/news/xs.aspx?title=text&nicheng=1&phone=65151039&content=1", W3Client::reqPostMultipartsFormdata)){
			char buf[1024]="\0";
